    ...
    const validar = () =>{
      ...
      const cadastrar = () => {
        ...
        console.log(aux)
          ...
          atendimentoService.marcarHora(data)
          .then((response)=>{
            Alert.alert("Sucesso!", "Atendimento marcado",[
                {text: 'OK'}
            ])
    ...
    return(
        ...
        <ScrollView>
            <View style={styles.container}>
                <Text h1 style={styles.loginTit}>Marcar Atendimento</Text>

                <Text h4 style={styles.label}>Cliente:</Text>
                ...
                <Text h4 style={styles.label}>Horário:</Text>
                <View style={styles.containerMask}>
                <Icon type= 'font-awesome'
                        name= 'clock' 
                        style={styles.icon}
                ...
                <Text h4 style={styles.label}>Descrição:</Text>
                <Input
